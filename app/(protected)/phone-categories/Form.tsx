...
export default function Form() {
  ...
  return (
    <DisplayFormDrawer
      ...
      isLoading={isLoading}
      open={open}
      title={isEdit ? "Edit Phone Category" : "Create Phone Category"}
      description={
        isEdit
          ? "Update phone category information."
          : "Fill in the form below to create a new phone category."
      }
    >
      <form>
        <FieldSet>
          <div className="mb-6 flex flex-wrap gap-4">
            <div className="min-w-[200px] flex-1">
              ...
              <MediaPicker
                onChange={(media) => {
                  setThumbnail((media as IMedia | undefined) ?? null)
                }}
          ...
          <FieldGroup className="grid gap-3">
            ...
            >
              <Controller
                ...
                name="slug"
                render={({ field }) => (
                  <Input {...field} placeholder="category-slug (optional)" />
                )}
              />
            </FormFieldWrapper>
            ...
            <FormFieldWrapper
              label="Icon Name"
              error={form.formState.errors.icon_name?.message}
            >
              <Controller
                control={form.control}
                name="icon_name"
                render={({ field }) => (
                  <Input
                    {...field}
                    placeholder="Icon name (e.g. Camera, Zap)"
                  />
                )}
              />
            </FormFieldWrapper>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Select value={field.value} onValueChange={field.onChange}>
                    ...
                    <SelectContent>
                      <SelectItem value={PhoneCategoryStatus.ACTIVE}>
                        Active
                      </SelectItem>
                      <SelectItem value={PhoneCategoryStatus.INACTIVE}>
                        Inactive
                      </SelectItem>
                    </SelectContent>
                  </Select>
