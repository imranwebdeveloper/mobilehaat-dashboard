...
import { useSellerSubscriptionTable } from "./useSellerSubscriptionTable"

const SellerSubscriptionTable = () => {
  const { table, columns, tableData, paginate, isLoading, isError } =
    useSellerSubscriptionTable()
...
export default SellerSubscriptionTable
